...
export default function DomainPicker({ value, onChange }: Props) {
  return (
    <select
      ...
      className="rounded-lg border border-ink/20 px-4 py-2 text-sm bg-card transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6384ff]/40 focus-visible:border-transparent"
    >
      {DOMAINS.map((d) => (
